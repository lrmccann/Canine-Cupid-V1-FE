    ...
    <div>
      ...
      <Container fluid style={{ margin: "0 0 0 0" }}>
        ...
        <Row>
          <Col size="md-12">
            <MatchCards
              img={require("../components/MatchCards/images/small-profile-pic-one.png")}
              userName="MSkwiot"
              messages="Hey wanna grab a pup cup?"
              {...MessageButton}
            />
          </Col>
        </Row>
        <Row>
          <Col size="md-12">
            <MatchCards
              img="https://i.vippng.com/png/small/355-3554387_create-digital-profile-icon-blue-profile-icon-png.png"
              userName="Jon123"
        ...
        <Row>
          <Col size="md-12">
            <MatchCards
              img="https://upload.wikimedia.org/wikipedia/commons/4/41/Profile-720.png"
              userName="Puppyluver"
              messages="Woooooooooow what a cute doggo"
              {...MessageButton}
            />
          </Col>
        </Row>
        <Row>
          <Col size="md-12">
            <MatchCards
              img="https://cdn2.vectorstock.com/i/thumb-large/20/76/man-avatar-profile-vector-21372076.jpg"
              userName="JWingo401"
              messages="Hey good lookin"
              {...MessageButton}
